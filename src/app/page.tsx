...
export default function Home() {
  return (
    <main className="min-h-screen bg-background text-foreground pl-4 lr-0 pt-10 pb-10 sm:px-2 sm:pt-10 sm:pb-10 md:pt-10 md:pb-10 lg:pt-12 lg:pb-12 md:p-10 lg:p-12 font-normal text-[4.9vw] sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl leading-tight sm:leading-tight">
      <ThemeToggle />
      <div>
        <div className="relative max-w-screen-2xl mx-auto flex flex-col gap-8 sm:gap-10 md:gap-12 lg:gap-14">
          ...
          <div className="flex mb-4 sm:mb-8 md:mb-12 lg:mb-16 xl:mb-20">
            ...
            <div className="">
              <h1 className="pb-0.5 md:pb-0.5 lg>pb-1">
                <ScrambleIn
                  delay={getAnimationDuration("ege serin")}
                  scrambledLetterCount={SCRAMBLED_LETTER_COUNT}
                  scrambleSpeed={SCRAMBLE_SPEED}
                >
                  design ✺ tech ∿ build ◳
              ...
              >
                <ScrambleCombined
                  delay={getAnimationDuration("ege serin") + ROW_DELAY}
                  scrambledLetterCount={SCRAMBLED_LETTER_COUNT}
                  scrambleSpeed={SCRAMBLE_SPEED}
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  <ScrambleCombinedPair
                    ...
                    delay={
                      ROW_DELAY * 3 +
                      getAnimationDuration("ege serin") +
                      ROW_DELAY * index
                    }
                    scrambledLetterCount={SCRAMBLED_LETTER_COUNT}
                    scrambleSpeed={SCRAMBLE_SPEED}
          ...
          <div className="flex">
            ...
            <ul>
              <li>
                <ScrambleIn
                  delay={ROW_DELAY * 15 + getAnimationDuration("ege serin")}
                  scrambledLetterCount={SCRAMBLED_LETTER_COUNT}
                  scrambleSpeed={SCRAMBLE_SPEED}
                >
                  egecan.s@icloud.com
